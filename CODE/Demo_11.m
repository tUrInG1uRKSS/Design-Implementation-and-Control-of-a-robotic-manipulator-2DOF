% Traking del motor DC con usando control por adelanto
% y retroalimentacion de posicion
...
for k=1:MM
    ...
    THREF(k) = thref;
    % PRIMERA Y SEGUNDA DERIVADA DE LA REFERENCIA
    ...
    ERR(k) = e;
    %  SEÑAL DE CONTROL
    u = (Kp*Tp)*e + Kp*Ts*sum_e + dthref/km + ddthref*(Tm/km);
    if(abs(u)>3.3)
        u = sign(u)*3.3;
    end
